...
export function formatHelp(): string {
  return [
    ...
    `  /export — Export full session as Markdown file 📄`,
    `  /save — Export latest reply to Notebook ${ICONS.save}`,
    `  /projects — Switch & manage workspaces ${ICONS.project}`,
    '',
    '<b>Finance & Tools</b>',
    `  /invest — Value investing 6-dimension report & compare 📊`,
    `  /stock — Query real-time stock & crypto quotes 📈`,
    `  /watchlist — Stock watchlist & daily AI market review ⭐️`,
    `  /read — Smart deep summary for URLs/Papers/GitHub/Articles 📖`,
    `  /sum — Summarize recent chat messages or URL 📝`,
    '',
    '<b>Automation & Diagnostics</b>',
    `  /autopilot — Autonomous problem solving ${ICONS.bot}`,
    `  /schedule — Manage recurring & timed tasks ${ICONS.clock}`,
    `  /backends — Monitor model backends health & cooldowns 🛡️`,
    `  /usage — View session token usage & cost stats 📊`,
    '',
    '<b>Models & Settings</b>',
    ...
    `• Compare stocks: <code>/invest 600519,000858</code> or <code>/invest NVDA vs AAPL</code>`,
    `• Voice & audio notes are automatically transcribed and answered`,
